...
import veribaseplugin.notifiers.ClueNotifier;
import veribaseplugin.notifiers.CollectionNotifier;
import veribaseplugin.notifiers.CombatTaskNotifier;
import veribaseplugin.notifiers.DeathNotifier;
import veribaseplugin.notifiers.DiaryNotifier;
import veribaseplugin.notifiers.GambleNotifier;
import veribaseplugin.notifiers.GrandExchangeNotifier;
import veribaseplugin.notifiers.GroupStorageNotifier;
import veribaseplugin.notifiers.KillCountNotifier;
import veribaseplugin.notifiers.LevelNotifier;
import veribaseplugin.notifiers.LootNotifier;
import veribaseplugin.notifiers.MetaNotifier;
import veribaseplugin.notifiers.PetNotifier;
import veribaseplugin.notifiers.PlayerKillNotifier;
import veribaseplugin.notifiers.QuestNotifier;
import veribaseplugin.notifiers.SlayerNotifier;
import veribaseplugin.notifiers.SpeedrunNotifier;
import veribaseplugin.notifiers.TradeNotifier;
import veribaseplugin.util.KillCountService;
...
public class VeribasePlugin extends Plugin {
    public static final String USER_AGENT = RuneLite.USER_AGENT + " (Veribase/1.x)";
    ...
    protected void shutDown() {
        log.debug("Shutting down Veribase");
        this.resetNotifiers();
    ...
    @Provides
    VeribasePluginConfig provideConfig(ConfigManager configManager) {
        return configManager.getConfig(VeribasePluginConfig.class);
    }
