...
public class NotificationBody<T extends NotificationData> {
     ...
     * <p>
     * This is only sent if {@link VeribasePluginConfig#sendDiscordUser()} is enabled.
     ...
     * <p>
     * This is done by {@link DiscordMessageHandler#createMessage} if {@link veribaseplugin.VeribasePluginConfig#discordRichEmbeds()} is disabled.
     */
    @Nullable
