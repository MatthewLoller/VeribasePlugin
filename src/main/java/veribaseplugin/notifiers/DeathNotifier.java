...
import veribaseplugin.domain.Danger;
...
import veribaseplugin.notifiers.data.DeathNotificationData;
...
import veribaseplugin.util.Region;
...
public class DeathNotifier extends BaseNotifier {
    ...
    public void onGameMessage(String message) {
        if (shouldNotifyExceptionalDangerousDeath(ExceptionalDeath.TOA) && message.contains(TOA_DEATH_MSG)) {
            // https://github.com/pajlads/VeribasePlugin/issues/316
    ...
    private boolean shouldNotifyExceptionalDangerousDeath(ExceptionalDeath death) {
        ...
        // notifier must be enabled to veribase when the actually dangerous death occurs
        return isEnabled();
    }
