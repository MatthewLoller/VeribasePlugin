...
import veribaseplugin.notifiers.data.GroupStorageNotificationData;
...
import static veribaseplugin.notifiers.GroupStorageNotifier.EMPTY_TRANSACTION;
...
class GroupStorageNotifierTest extends MockedNotifierTest {
    ...
    private static final String GROUP_NAME = "Veribase QA";
